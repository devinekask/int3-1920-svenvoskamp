{
  const dreams = [{
    dream: `#Droom 12`,
    text: `“Ik loop rond door het bos. Ik ben mijn vader kwijt. Hij zou mij nooit alleen laten. Hij was op zoek naar voedsel en zou binnen twee minuten terug zijn. Ik schreeuw de naam van mijn vader, maar het enige wat ik hoor is mijn eigen echo. Ik begin te rennen. Ik moet mijn vader vinden. Ik hoor een geweerschot. Ik volg het geluid en zie dat mijn vader op de grond ligt. Ik schrik wakker.”`
  },
  {
    dream: `#Droom 52`,
  ...
  const cans = [{
    id: 1,
    can: `Cola`,
    text: `“Mijn vader overhandigt mij het blikje cola. Ik kijk ernaar. Met mijn hand haal ik het stof er vanaf. Mijn vader vertelt over vroeger. Hoe hij kon genieten van een blikje cola na een lange dag werken. Ik vraag of hij een slokje wilt, maar hij weigert. Hij zegt <span
  ...
  const createContent = can => {
    const $selectContent = document.querySelector(`.div__vending--content`);
