...
<section class="container section__cart">
  <div class="container__dashed section__cart--main">
    ...
    <div class="div__cart--flex">
      ...
      ?>
          <a
            href="index.php?page=product-detail&id=<?php echo $product['product']['product_id'];?>&type=<?php echo $product['product']['type_id'];?>">
            <div class="cart__item">
              ...
              <div class="div__cart--info">
                ...
                <p class="bold uppercase verysmall p__cart--info <?php echo $product['product']['color'];?>">
                  <?php echo $product['product']['color'];?></p>
          ...
          <input class="td__quantity" type="number" name="quantity[<?php echo $product['product']['id']?>]"
            value="<?php echo $product['quantity']?>" class="replace" required />
          <p class="red bold small p__cart--info-price">&#8364;<?php echo $productTotal;?></p>
      </div>
      <button type="submit" class="button__cart--remove" name="remove"
  ...
  <div class="div__recipe--flex">
    <div class="div__cart--recipe div__cart--recipe-2">
      ...
      <div class="flex div__recipe--bottom">
        ...
        <p class="medium bold p__bottom--amount">
          &#8364;<?php $totalTotal += $afterDiscountTotal;
