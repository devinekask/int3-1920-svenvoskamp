      ...
      <div class="container">
        <nav class="road__nav">
          <ul class="ul__nav--road">
            <li class="white li__nav--road li__nav--road-1"><a class="a__road" href="index.php?page=products">&lt; naar
                de shop</a></li>
            <li class="white li__nav--road"><a class="a__road" href="index.php?page=products"><img
                  class="img__back--svg" src="./assets/img/img_road/back.svg" alt="back button"></a></li>
            <li class="li__nav--road"><img class="img__road--logo-b" src="./assets/img/img_road/logo.png" alt="logo">
            </li>
            <li class="li__nav--road"><img class="img__road--logo-s" src="./assets/img/img_road/logo_480.png"
                alt="logo"></li>
            <li class="white li__nav--road"><a class="a__road" href="index.php?action=&page=home&type%5B%5D=1"><img
                  class="img__book--svg" src="./assets/img/img_road/book.svg" alt="book button"></a></li>
            <li class="white li__nav--road"><a class="a__road" href="index.php?action=&page=home&type%5B%5D=1">andere
                boeken></a></li>
          </ul>
        </nav>
      </div>
      ...
      <nav class="nav__desktop">
        ...
        <div class="nav__main">
          <ul class="container nav__main--flex">
            ...
            <li><a href="index.php"><img class="img__nav--main" width="149" height="69" src="../assets/img/logo.svg"
                  alt="Humo logo"></a></li>
            ...
            <li><img class="img__nav--main img__nav--search" width="24" height="24" src="../assets/img/search.svg"
                alt="Search Icon"></li>
          </ul>
        </div>
      </nav>
      <nav class="nav__tablet">
        <div class="nav__top container">
          <div class="nav__top--left">
            <img class="img__nav--main" width="24" height="24" src="../assets/img/menu.svg" alt="Hamburger Icon">
            <img class="img__nav--main img__nav--search" width="24" height="24" src="../assets/img/search.svg"
              alt="Search Icon">
          </div>
          <ul class="nav__top--right">
            <li class="li__nav--right"><span class=span__nav--red>Nu in HUMO</span></li>
      ...
      <nav class="nav__mobile">
        <div class="nav__top container">
          ...
          <div class="nav__top--mid">
            <a href="index.php"><img class="img__mobile--logo" width="128" height="46" src="./assets/img/logosmall.svg"
                alt="Small logo"></a>
          </div>
